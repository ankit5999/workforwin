    ...
    case 0: return (
      <div className="flex flex-col px-4 sm:px-6 lg:px-8 py-12">
        ...
        >
          ...
          <SignInForm onSuccess={(value) => setStateValue(value)} />
    ...
    case 1: return (
      <div className="flex flex-col px-4 sm:px-6 lg:px-8 py-12">
        ...
        >
          ...
          <SendOTPForm onSuccess={(value) => setStateValue(value)} />

        </motion.div>
      </div>
    );

    case 2: return <VerifyOTPPage onSuccess={(value) => setStateValue(value)} />;
    case 3: return <div className="flex flex-col px-4 sm:px-6 lg:px-8 py-12">
      {/* Logo */}
      <div className="mb-12 flex justify-around lg:justify-normal">
        <Link href="/" className="flex items-center gap-2">
          <div className="w-8 h-8 rounded-lg bg-appPurple-900 flex items-center justify-center">
      ...
      >
        ...
        <ResetPasswordForm onSuccess={(value) => setStateValue(value)} />
