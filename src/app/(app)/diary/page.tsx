...
export default function CaseStudiesPage() {
  ...
  // const handleFilterClick = (newQuery:any) => {
  //   setSearchQuery(newQuery); // ✅ Updates state

  //   // Update URL
  //   const params = new URLSearchParams(searchParams);
  //   params.set("filter", "");

  //   router.push(`${pathname}`, { scroll: false }); // ✅ Uncomment after testing logs
  // };
      ...
      <div className="max-w-7xl mx-auto px-4 py-20">
        <div className="grid lg:grid-cols-4 gap-8">
          <div className="lg:col-span-1 relative">
            ...
            <div className="flex lg:flex-col gap-2 lg:sticky lg:top-20">
              <button
                onClick={() => setIsCategoriesOpen(!isCategoriesOpen)}
                className="lg:hidden px-4 py-0 h-12 bg-white rounded-xl shadow-lg flex items-center justify-between"
              >
                <Filter className="w-5 h-5" />
                <span className="text-medium pl-2 hidden md:block">Filter</span>
              </button>
              <motion.div
                initial={{ opacity: 0, y: 20 }}
                animate={{ opacity: 1, y: 0 }}
                transition={{ duration: 0.5 }}
                className="mb-8 z-40 w-full"
              >
                <div className="relative">
                  <input
                    ...
                    className="w-full h-12 px-4 py-3 pl-12 rounded-xl border border-gray-200 focus:ring-2 focus:ring-appPurple-900 focus:border-transparent transition-all"
                  />
            ...
            <AnimatePresence>
              {isCategoriesOpen && (
                <motion.div
                  ...
                  className="overflow-hidden lg:sticky lg:top-40"
                >
                  ...
                  <div className="hidden lg:block bg-white rounded-lg p-6 overflow-hidden border border-gray-200">
          ...
          <div className="lg:col-span-3 relative">
            {/* <motion.div
              ...
              animate={{ opacity: 1, y: 0 }}
              transition={{ duration: 0.5 }}
              className="mb-8 hidden lg:block lg:sticky lg:top-20 z-40"
            >
              <div className="relative">
                <input
                  type="text"
