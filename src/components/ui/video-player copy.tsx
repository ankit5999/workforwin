...
export function VideoPlayer({ url, watermark, className }: VideoPlayerProps) {
    ...
    //     video.autoplay = true;
    //     video.muted = true; // Required for autoplay in most browsers
    //     setIsMuted(true); // Ensure UI state is correct

    //     // Try playing the video explicitly
    ...
    //     setIsMuted(true); // Update UI state
    //     setIsLoading(true); // Show loader initially

    //     // Delay playback to show the loader
    //     const playVideo = () => {
    //         setTimeout(async () => {
    //             try {
    //                 await video.play();
    ...
    //                 // Unmute after video starts playing (optional)
    //                 video.muted = false;
    //                 setIsMuted(false);
    //             } catch (error) {
    //                 console.error("Autoplay failed:", error);
    ...
    useEffect(() => {
        ...
        const playVideo = async () => {
            try {
                ...
                // If autoplay fails on mobile, show a "Tap to Play" button
